...
\begin{table}[H]
	...
	\begin{tabular}{|c||c|c|c||c|c|c||c|c|c|}
		...
		\textbf{Method}& White & Gray & CSF & White & Gray & CSF & White & Gray & CSF\tabularnewline
		\hline 
		Zero-filled & 0.882~$\pm$~0.08 & 0.826~$\pm$~0.05 & 0.796~$\pm$~0.05 & 0.718~$\pm$~0.10 & 0.644~$\pm$~0.05 & 0.627~$\pm$~0.05 & 0.599~$\pm$~0.12 & 0.466~$\pm$~0.07 & 0.050~$\pm$~0.06\tabularnewline
		\hline 
		CS-MRI & 0.942~$\pm$~0.05 & 0.910~$\pm$~0.03 & 0.868~$\pm$~0.03 & 0.871~$\pm$~0.10 & 0.805~$\pm$~0.08 & 0.770~$\pm$~0.05 & 0.708~$\pm$~0.14 & 0.639~$\pm$~0.08 & 0.621~$\pm$~0.07     \tabularnewline
		\hline 
		CNN-L2 & 0.948~$\pm$~0.02 & 0.919~$\pm$~0.02 & 0.891~$\pm$~0.02 & 0.888~$\pm$~0.06 & 0.836~$\pm$~0.04 & 0.813~$\pm$~0.03 & 0.836~$\pm$~0.09 & 0.770~$\pm$~0.06 & 0.747~$\pm$~0.06     \tabularnewline
		\hline

		\textbf{Proposed} & \textbf{0.954~$\pm$~0.01} & \textbf{0.928~$\pm$~0.02} & \textbf{0.900~$\pm$~0.002} & \textbf{0.903~$\pm$~0.06} & \textbf{0.858~$\pm$~0.04} & \textbf{0.833~$\pm$~0.03} & \textbf{0.851~$\pm$~0.09} & \textbf{0.789~$\pm$~0.06} & \textbf{0.767~$\pm$~0.06}     \tabularnewline
		\hline 
	\end{tabular}
	}
